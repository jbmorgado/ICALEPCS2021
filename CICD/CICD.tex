...
\title{CI-CD Practices at SKA (Square Kilometre Array)}
...
\keywords{CI/CD, SKA, TANGO, Continuous Integration, Continuous Delivery, Systems Team, TANGO controls framework, Construction, Software Development}
